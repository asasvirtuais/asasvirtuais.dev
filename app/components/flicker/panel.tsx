...
const Panel = forwardRef<any>((_props, ref) => (
    <Box py={12} px={1} maxW='100%' as='button' role='group' display='flex'>
        <Card
            ref={ref}
            rounded='none'
            width='300px'
        ...
        >
            ...
            <CardBody pointerEvents='none'>
                <Text textAlign='left' fontSize={0.857 + 'em'} noOfLines={3} textOverflow='ellipsis' overflow='hidden' _groupFocus={{ noOfLines: 16 }} >
